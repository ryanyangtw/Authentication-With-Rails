...
struct HTTPHelper {
  static let API_AUTH_NAME = "Ryan" //"<YOUR_HEROKU_API_ADMIN_NAME>"
  static let API_AUTH_PASSWORD = "CB064E304ACABEDF5A7BFDE942" //"<YOUR_HEROKU_API_PASSWORD>"
  static let BASE_URL = "https://ios-api-server.herokuapp.com/api"
  //"http://localhost:3000/api" 
  //"https://XXXXX-XXX-1234.herokuapp.com/api"
  ...
  func uploadRequest(path: String, data: NSData, title: NSString) -> NSMutableURLRequest {
    ...
    // create an instance of NSMutableURLRequest and sets an Authoruzation header
    // multipar/form-data: teslls the server the request body is a series of parts. And each part is separated by a boundary
